...
namespace AWL.Modules.NLog
{
	public class LoggerAdapter : ILogger
	{
		...
		public LoggerAdapter(N.Logger logger)
		{
			_logger = logger;
		}

		public static N.LogLevel ToNLogLevel(LogLevel logLevel)
		{
			switch (logLevel)
			{
				case LogLevel.Debug:
		...
		public N.LogFactory Factory { get { return _logger.Factory; } }
		...
		{
			_logger.Log(ToNLogLevel(level), value);
		}

		public void Log<T>(LogLevel level, IFormatProvider formatProvider, T value)
		{
			_logger.Log(ToNLogLevel(level), formatProvider, value);
		}
		...
		{
			_logger.Log(ToNLogLevel(level), formatProvider, message, args);
		}
		...
		{
			_logger.Log(ToNLogLevel(level), formatProvider, message, argument1, argument2);
		}

		public void Log<TArgument1, TArgument2>(LogLevel level, string message, TArgument1 argument1, TArgument2 argument2)
		{
			_logger.Log(ToNLogLevel(level), message, argument1, argument2);
		}
		...
		{
			_logger.Log(ToNLogLevel(level), formatProvider, message, argument1, argument2, argument3);
		}
		...
		{
			_logger.Log(ToNLogLevel(level), message, argument1, argument2, argument3);
		}
